...
class BookController extends Controller
{
    ...
    public function antrianAdd(Request $request)
    {
        ...
        $dataAntrianFaskes = AntrianFaskes::firstOrCreate(
          [
          'faskes_id' => $faskes_id,
          'dokter_id' => $dokter_id,
          'sesi_start' => $sesi_start,
    ...
    {
        $sid = 'AC14f82e6512ca65d6e2c46c4a429ad641';
        $token = '52a5d07525d8dde66c4dd37a6eed34a0';
    ...
    public function sendTelegram(Request $request)
    {
        ...
        // $tgLog = new TgLog('846998010:AAEXsUygiq-0qEFP96u8Mu7CEeRVofieTYw', $handler);

        // $sendMessage = new SendMessage();
        // $sendMessage->chat_id = '383327214';
        // $sendMessage->text = 'Hello Dedyyy cek php!';
        ...
        // echo 'its finish';
        //curl
        $endpoint = 'https://api.telegram.org/bot846998010:AAEXsUygiq-0qEFP96u8Mu7CEeRVofieTYw/sendMessage';
